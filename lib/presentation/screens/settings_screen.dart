...
class SettingsScreenState extends State<SettingsScreen>
  ...
  Widget _buildGeneralTab(AppTheme theme) => ListView(
  ...
  Widget _buildPingerCard(AppTheme theme) => Card(
    elevation: 0,
    color: theme.surface,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(12),
  ...
  Widget _buildProxyTab(AppTheme theme) => Column(
    children: [
      Padding(
        padding: const EdgeInsets.all(16),
        child: Card(
  ...
  Widget _buildLogsTab(AppTheme theme) => Column(
    children: [
      Padding(
  ...
  Future<void> _exportLogs(AppTheme theme) async {
    ...
    try {
      final sb = StringBuffer()
        ..writeln('=== MaxSpeed VPN Logs ===')
        ..writeln('Exported: ${DateTime.now().toIso8601String()}')
        ..writeln('Total: ${logs.length} entries')
        ..writeln('=' * 40)
        ..writeln();
  ...
  Widget _buildThemeTab(AppTheme theme) => ListView(
    padding: const EdgeInsets.all(16),
    children: [
  ...
  Widget _sectionTitle(AppTheme theme, String title) => Padding(
  ...
  Widget _infoTile(AppTheme theme, String label, String value) => ListTile(
    title: Text(
      label,
  ...
  Widget _buildVersionTile(AppTheme theme) => FutureBuilder<String>(
